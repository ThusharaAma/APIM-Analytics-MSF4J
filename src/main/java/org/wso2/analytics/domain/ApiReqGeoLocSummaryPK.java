...
/**
 * The primary key class for the API_REQ_GEO_LOC_SUMMARY database table.
 * 
 */
@Embeddable
public class ApiReqGeoLocSummaryPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ApiReqGeoLocSummaryPK)) {
			return false;
		}
		ApiReqGeoLocSummaryPK castOther = (ApiReqGeoLocSummaryPK)other;
		return 
