...
/**
 * The persistent class for the API_EXE_TIME_HOUR_SUMMARY database table.
 * 
 */
@Entity
@Table(name="API_EXE_TIME_HOUR_SUMMARY")
@NamedQuery(name="ApiExeTimeHourSummary.findAll", query="SELECT a FROM ApiExeTimeHourSummary a")
public class ApiExeTimeHourSummary implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private ApiExeTimeHourSummaryPK id;
	...
	public ApiExeTimeHourSummary() {
	}

	public ApiExeTimeHourSummaryPK getId() {
		return this.id;
	}

	public void setId(ApiExeTimeHourSummaryPK id) {
		this.id = id;
	}
