...
/**
 * The primary key class for the API_EXE_TIME_HOUR_SUMMARY database table.
 * 
 */
@Embeddable
public class ApiExeTimeHourSummaryPK implements Serializable {
	...
	public ApiExeTimeHourSummaryPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ApiExeTimeHourSummaryPK)) {
			return false;
		}
		ApiExeTimeHourSummaryPK castOther = (ApiExeTimeHourSummaryPK)other;
		return 
