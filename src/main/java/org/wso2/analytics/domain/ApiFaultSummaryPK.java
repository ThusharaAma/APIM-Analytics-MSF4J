...
/**
 * The primary key class for the API_FAULT_SUMMARY database table.
 * 
 */
@Embeddable
public class ApiFaultSummaryPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ApiFaultSummaryPK)) {
			return false;
		}
		ApiFaultSummaryPK castOther = (ApiFaultSummaryPK)other;
		return 
