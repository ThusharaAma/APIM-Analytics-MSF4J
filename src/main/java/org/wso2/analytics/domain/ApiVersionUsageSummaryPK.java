...
/**
 * The primary key class for the API_VERSION_USAGE_SUMMARY database table.
 * 
 */
@Embeddable
public class ApiVersionUsageSummaryPK implements Serializable {
	...
	public ApiVersionUsageSummaryPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ApiVersionUsageSummaryPK)) {
			return false;
		}
		ApiVersionUsageSummaryPK castOther = (ApiVersionUsageSummaryPK)other;
		return 
